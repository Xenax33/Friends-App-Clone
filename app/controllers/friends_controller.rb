class FriendsController < ApplicationController
  ...
  def correct_model
    ...
    redirect_to friends_path, notice: "You are not authorized to access this friend." if @friend.nil?
  end
  ...
  private
    ...
    def friend_params
      params.expect(friend: [ :first_name, :last_name, :email, :city, :model_id ])
    end
end
